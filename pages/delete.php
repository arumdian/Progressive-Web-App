      ...
      <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="left_content">
		  ...
		  <ol class="breadcrumb">
			...
			<h1 align="center" class="style1">HAPUS BERITA<br><br>
	</section>
<body>
</html>
...
if (isset($_POST['delete'])) {
 ...
 'gambar'=>$_POST['gambar']);
 //Menggunakan method "call" untuk memanggil function delete
 $result = $client->call('delete',array($param));
 if ($result['status'] == 1) {
	 //Menampilkan Pesan
...
<textarea id = "isi" name="isi" style="height:200px">'.$item['isi'].'</textarea>
 ...
 <input type="submit" name="delete" value="HAPUS BERITA">
 </table></form>';
 }
 ?>
<br>
